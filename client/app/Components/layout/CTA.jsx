          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              <p className="text-gray-600">
                This project represents a comprehensive implementation of modern
                option pricing theory, combining financial mathematics with
                interactive visualization and practical applications.
              </p>
