          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              <p className="text-gray-600">
                Help us improve our option pricing models and simulations. Add
              ...
              <div className="flex flex-wrap gap-3 md:ml-11">
                <a
                  ...
                  target="_blank"
                  className="inline-flex justify-center items-center gap-2 font-medium text-white bg-gradient-to-r from-indigo-600 to-indigo-500 hover:from-indigo-700 hover:to-indigo-600 py-2.5 px-4 rounded-lg shadow-md hover:shadow-lg transition-all"
                >
                  <svg aria-hidden="true" className="h-5 w-5 fill-white">
