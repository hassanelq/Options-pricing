...
% Protect these commands to avoid errors
\usepackage{etoolbox}
\pretocmd{\listofalgorithms}{\chapter*{\listalgorithmcfname}}{}{}
\providecommand{\listofalgorithms}{} % define empty if missing
\providecommand{\listalgorithmcfname}{Liste des algorithmes} % define name
